...
export function EstadoFisicoCard({ observaciones }: EstadoFisicoCardProps) {
  // Determinar el estado basado en palabras clave en las observaciones
  const determinarEstado = (texto: string | undefined) => {
  ...
  // Configurar el icono y color según el estado
  ...
  const { icon: Icon, color, bgColor, badgeColor } = getIconAndColor()
